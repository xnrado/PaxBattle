    ...
    <div class="p-6 grid grid-cols-3 gap-3">
        ...
        @can('create_battles')
            <div class=" min-h-64 px-8 flex items-center justify-center rounded animate-fade-up animate-duration-500 animate-delay-500 animate-once">
                <a href="/battles/create" class="bg-nord-2/50 w-40 h-40 rounded-full flex items-center justify-center hover:bg-nord-2 transition duration-300 ease-in-out group">
                    <svg fill="#e5e9f0" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="96px" height="96px" viewBox="-4.54 -4.54 54.48 54.48" transform="rotate(90)" class="group-hover:rotate-0 transition duration-500 ease-in-out rounded-full">
